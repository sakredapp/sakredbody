 ...
 *
 * NOT part of the plugin target. This file belongs to a Widget Extension
 * target you add in Xcode — see docs/widget-setup.md. It lives here so the
 * source is version-controlled alongside the code that feeds it, rather than
 * existing only inside a project file.
 *
